...
> **Question 10.10:** Report the `TstWordsCorrel` values for several additional sets of Words comparisons, along with how well each matches your intuitive semantics from having read this textbook yourself.
