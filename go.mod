...
require (
	cogentcore.org/core v0.3.3-0.20240829172442-d6d1370bf29e
	github.com/emer/emergent/v2 v2.0.0-dev0.1.0.0.20240828235017-926d9b3fe409
	github.com/emer/leabra/v2 v2.0.0-20240828203446-ed37c15fe5b1
)
