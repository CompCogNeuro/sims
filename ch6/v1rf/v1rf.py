...
class Sim(pyviews.ClassViewObj):
    ...
    def ConfigNet(ss, net):
        ...
        lgnOff.SetRelPos(
            relpos.Rel(Rel=relpos.RightOf, Other="LGNon", YAlign=relpos.Front, Space=2)
        )
        v1.SetRelPos(
            relpos.Rel(
                Rel=relpos.Above,
    ...
    def ConfigGui(ss):
        ...
        tbar.AddAction(
            core.ActOpts(
                ...
                Icon="updt",
                Tooltip="Open weights trained with excitatory lateral (recurrent) con scale = .2.",
                UpdateFunc=UpdateFuncNotRunning,
            ),
            recv,
            OpenRec2WtsCB,
        ...
        tbar.AddAction(
            core.ActOpts(
                ...
                Icon="updt",
                Tooltip="Open weights trained with excitatory lateral (recurrent) con scale = .05.",
                UpdateFunc=UpdateFuncNotRunning,
            ),
            recv,
            OpenRec05WtsCB,
        ...
        tbar.AddAction(
            core.ActOpts(
                Label="V1 RFs",
                Icon="file-image",
                Tooltip="Update the V1 Receptive Field (Weights) plot in V1 RFs tab.",
                UpdateFunc=UpdateFuncNotRunning,
            ),
            recv,
            V1RFsCB,
